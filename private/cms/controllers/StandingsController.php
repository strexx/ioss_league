...
class StandingsController extends Cms {

    public function listAction() 
    {
        $q = $this->_db->prepare('SELECT * FROM standings ORDER BY `standings`.`position` ASC');
        $q->execute();
    ...
    public function editAction() {
        ...
        $form = $this->view->form = new StandingsForm($this->_getParam('id',false));
    ...
    public function deleteAction() {
        ...
        $q_delete = $this->_db->prepare('DELETE FROM standings WHERE id = :id');
