...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            '</div>' +
            (!this._options.listElement ? '<br/><ul class="qq-upload-list"></ul>' : ''),

        // template for one item in file list
        fileTemplate: '<li>' +
        '<a class="close mi-close" href="#">&times;</a>' +
            ...
            '<span class="qq-upload-status-text">{statusText}</span>' + '<span class="mi-upload-error"></span>' +
            '</li>',
        classes: {
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _onComplete: function(id, name, result, xhr){
        ...
        if (result.success) {
            ...
            qq(this._find(item, 'statusText')).setText(' [' + result.reason + ']');
        }
    },
