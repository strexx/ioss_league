...
$app_config = json_decode(file_get_contents(dirname(__FILE__) . '/../../private/config.json'),true);
...
$baseUrl = $app_config['baseurl'] . 'uploads/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => "500M",
		'allowedExtensions' => 'jpeg,jpg,gif,png,bmp,pdf',
		'deniedExtensions' => '');
