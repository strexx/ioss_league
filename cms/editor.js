...
this.btnList = {
    ...
    "custom1":        ['custom1',              'Registered Symbol',  'editor_action(this.id)',  'ed_custom1.gif'],
    "custom2":        ['custom2',              'Degree symbol',      'editor_action(this.id)',  'ed_custom2.gif'],
    "custom3":        ['custom3',              'Superscript 3',      'editor_action(this.id)',  'ed_custom3.gif'],
...
function editor_action(button_id) {
 ...
 // Custom1
  else if (cmdID == 'custom1') {  // insert some text
    editor_insertHTML(objname, "®");
  }

  // Custom2
  else if (cmdID == 'custom2') {  // insert some text
    editor_insertHTML(objname, "°");
  }
